...
\newcommand{\preferInput}[1]{%
  \begingroup
  \edef\prefBase{#1}%
  \edef\prefA{\prefBase\detokenize{_polished_unified.tex}}%
  \edef\prefB{\prefBase\detokenize{_polished.tex}}%
  \edef\prefC{\prefBase\detokenize{.tex}}%
  \IfFileExists{\prefA}{%
...
\preferInput{chapters/2-History-Math.v3.2} % 智能，生于数学
