...
\include{0-Intro}
\include{1-Def}  % 什么是智能
\include{2-History-Math.v2.1} % 智能，生于数学
\include{3-History-computer}  % 智能，成于计算机

%\part{学习的逻辑}
%\include{3-Thinking}  % 人工智能的三种思维
%\include{4-Tools}
%\include{5-ML.v2} % 机器学习：学习如何学习
%\include{6ML2DL} % 从传统机器学习到深度学习
%\include{7-DL} % 深度学习，真的行
%%\include{阅读地图}
%
%\part{理解的边界}
%\include{8-深度学习的挑战与幻觉} % 技术挑战
%\include{9-AI的边界：图灵机、哥德尔与计算的极限} % 理论边界
%\include{10-符号、神经与因果：智能的三种建构方式} % 智能的建构方式
%\include{11-智能的物理基础：从熵到量子计算} % 智能的物理基础
%
%\part{回归与超越}
%\include{12-语言中的智能：Transformer的意外胜利} % AI对语言的"结构感知"代表突破范式
%\include{13-AI+}  % AI的应用与发展
%\include{14-理解智能的尽头：理性与取舍的未来} % 人类对"智能"定义的终极反思
%\include{15-伦理与挑战}
%
%\include{8-RL} 
%
