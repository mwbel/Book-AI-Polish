\documentclass[lang=cn,10pt,cite=super]{elegantbook}
...
参考文献\cite{cn1,cn2, en1, en2}. 

\nocite{*}
\printbibliography[heading=bibintoc, title=\ebibname]
%\appendix
%\bibliography{references} % references 是 .bib 文件的名字，不需要扩展名
%\bibliographystyle{plain} % 或其他样式如 ieee、unsrt 等
